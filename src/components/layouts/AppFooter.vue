        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex justify-content-around">
                    ...
                    <!-- PHP -->
                    <a target="_blank" href="https://www.php.net/manual/en/index.php">
        ...
        <div class="container">
            ...
            <div class="row align-items-center pt-4">
                ...
                <div class="col d-flex align-items-center justify-content-end gap-3">
                    ...
                    <!-- linkedin -->
                    <a target="_blank" href="https://www.linkedin.com/in/lorenzo-neri-a32248262/">
                    ...
                    <!-- github -->
                    <a target="_blank" href="https://github.com/lorenzo-neri">
                    ...
                    <!-- mail -->
                    <a target="_blank" href="mailto:lorenzo21neri@gmail.com">
